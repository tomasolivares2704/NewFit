...
@Component({
  selector: 'app-crud-list-ejercicios',
  templateUrl: './crud-list-ejercicios.page.html',
  styleUrls: ['./crud-list-ejercicios.page.scss'],
})
export class CrudListEjerciciosPage implements OnInit {
